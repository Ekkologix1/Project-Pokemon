...
// src/components/PlayerStats.jsx - Actualización para mostrar monedas

// En el componente PlayerStats, asegúrate de mostrar las monedas:
...
<div className="bg-white/20 backdrop-blur-sm rounded-xl p-4 shadow-lg">
  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
    ...
    <div>
      <div className="text-2xl font-bold text-white">{playerData.experience}</div>
      <div className="text-sm text-white/80">EXP</div>
    </div>
    <div>
      <div className="text-2xl font-bold text-white">{playerData.coins || 0}</div>
      <div className="text-sm text-white/80">💰 Monedas</div>
    </div>
    <div>
      <div className="text-2xl font-bold text-white">{playerData.collection.length}</div>
      <div className="text-sm text-white/80">Capturados</div>
    </div>
  </div>
</div>

...
function App() {
  ...
  const menuItems = [
    ...
    { id: 'collection', label: 'Equipo', icon: PokemonIcons.collection, color: 'from-green-500 to-teal-500' },
    ...
    { id: 'storage', label: 'Caja', icon: PokemonIcons.storage, color: 'from-yellow-500 to-amber-500' }
  ]
